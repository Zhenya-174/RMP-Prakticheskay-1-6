...
/* @author Тюшкин Евгений Васильевич */
public class Game extends JFrame {
 ...
 papich = ImageIO.read(Game.class.getResourceAsStream("Rais.png"));
 nuts = ImageIO.read(Game.class.getResourceAsStream("GR.png"));
 end = ImageIO.read(Game.class.getResourceAsStream("Ser.png"));
 game_game = new Game();
